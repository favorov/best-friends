...
It is interesting to see that the tenht (worst) rank of E is unexpectedly far away from 1 (the right column). It means that E is generally higher in all the communities than by random. Actually, any normalisation would show the same. It is a good as sanity check.
