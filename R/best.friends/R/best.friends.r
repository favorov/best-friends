...
#'
#' [friends.test] does the same, but it considers more than one clouds as potential friends for each tag, and p-values are generated for each pair of the tag and the possible $m$ (number of friend clouds). If p-value is low and the null is rejected, the tag reliably separates the clouds: $m$ most friendly to $t_i$ clouds are real friends of the tag, others are not. The tag is the marker for all its friends.
#'
#' @docType package
#' @name best.friends
