...
noquote(all.friends)
```
The same friendship: the blue is the best friend for the orange. All the nodes but the red are better friends for the the orange than the red is ((uncorrected p-value=`r all.friends$pvals[5,4]`)).
