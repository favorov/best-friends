...
Suppose we have set of elements $E$ and a set of communities $C$ of this elements with some fuzzy membership, e.g. there is a numeric measure of how an element is represented in a community $A\left(e,c\right)$ for each pair $(e,c): e \in E, c \in C$. The higher the $A\left(e,c\right)$ value is, the more the element $e$ is involved in the community $c$. The absence of the element in the community is shown by the value that is minimal for the community. 
