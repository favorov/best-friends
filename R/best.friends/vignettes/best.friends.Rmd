...
Suppose we have set of tags $E$ and a set of clouds $C$ of this tags with some fuzzy membership, e.g. there is a numeric measure of how an tag is represented in a cloud $A\left(e,c\right)$ for each pair $(e,c): e \in E, c \in C$. The higher the y value is, the more the tag $e$ is involved in the cloud $c$. The absence of the tag in the cloud is shown by the value that is minimal for the cloud. 
