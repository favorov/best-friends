...
regulation[1,]<-c(0.2,4,3)
regulation[2,]<-c(0.25,3,1)
regulation[3,]<-c(0.1, 6 ,5 )
regulation[4,]<-c(0.23, 1 ,6 )
regulation[5,]<-c(0.3,9 ,3 )
regulation[6,]<-c(0.12,7 ,4 )
regulation[7,]<-c(0.14,10 ,11 )
noquote(regulation)
```
